                        ...
                        <div x-show="step === 1" x-transition>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="space-y-1">
                                    ...
                                    <input name="nik" required type="text" inputmode="numeric" oninput="this.value = this.value.replace(/[^0-9]/g, '');" maxlength="16" class="w-full px-5 py-3 bg-gray-50 rounded-xl border-2 border-transparent focus:border-red-500 outline-none transition-all">
                                </div>
                                <div class="space-y-1">
                                ...
                                <div class="space-y-1">
                                    ...
                                    <input name="phone" value="{{ old('phone') }}" required type="text" pattern="[0-9+\s\-]{10,20}" inputmode="numeric"
                                ...
                                <div class="space-y-1">
                                    ...
                                    <div class="flex gap-6 py-2">
                                        <label class="inline-flex items-center"><input type="radio" name="jk" value="L" required class="text-red-600 focus:ring-red-500"><span class="ml-2 text-sm text-gray-600">Laki-laki</span></label>
                                        <label class="inline-flex items-center"><input type="radio" name="jk" value="P" required class="text-red-600 focus:ring-red-500"><span class="ml-2 text-sm text-gray-600">Perempuan</span></label>
                                    </div>
                                </div>
                                <div class="space-y-1">
                                ...
                                <div class="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div class="space-y-1">
                                        ...
                                        <input name="tempat_lahir" type="text" required class="w-full px-5 py-3 bg-gray-50 rounded-xl border-2 border-transparent focus:border-red-500 outline-none">
                                    </div>
                                    <div class="space-y-1">
                                ...
                                <div class="space-y-1 md:col-span-2">
                                    ...
                                    <textarea x-model="alamat" name="alamat" required rows="2" class="w-full px-5 py-3 bg-gray-50 rounded-xl border-2 border-transparent focus:border-red-500 outline-none"></textarea>
                                </div>
