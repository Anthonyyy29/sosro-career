...
<body>
    <div class="container">
        <div class="header">
            ...
            <p style="margin:5px 0 0;">Head Office - PT Sinar Sosro Gunung Slamat</p>
        </div>
        <div class="content">
            ...
            <ul>
                <li>Senin - Jumat: Pukul 08.00 - 17.00</li>
                <li>Senin - Kamis: Kemeja bebas, celana kain/jeans, sepatu tertutup</li>
