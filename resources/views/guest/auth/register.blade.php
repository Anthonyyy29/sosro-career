...
@section('content')
    <div class="flex items-center justify-center bg-gray-50/30 px-4 py-12">
        <div
            class="w-full max-w-lg bg-white shadow-[0_20px_60px_rgba(0,0,0,0.07)] rounded-2xl overflow-hidden border border-gray-100/50">
            ...
            <div class="p-8 md:p-8">
                ...
                <form method="POST" action="{{ route('guest.register') }}" class="space-y-5">
                    @csrf
                    ...
                    <div>
                        ...
                        <div class="relative mt-1">
                            ...
                            <x-text-input id="name"
                                class="block w-full pl-11 pr-4 py-3.5 rounded-md border-gray-200 bg-gray-50 focus:bg-white focus:border-red-500 focus:ring-4 focus:ring-red-500/10 transition duration-200"
                        ...
                        <div>
                            ...
                            <div class="relative mt-1">
                                ...
                                <input id="password" type="password"
                                    class="block w-full pl-11 pr-11 py-3.5 rounded-md border-gray-200 bg-gray-50 focus:bg-white focus:border-red-500 focus:ring-4 focus:ring-red-500/10 transition duration-200"
                        ...
                        <div>
                            ...
                            <div class="relative mt-1">
                                ...
                                <button type="button"
                                    ...
                                    <svg id="eyeClose2" xmlns="http://www.w3.org/2000/svg" fill="none"
                                        viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                                            d="M3.98 8.223A10.477 10.477 0 0 0 1.934 12C3.226 16.338 7.244 19.5 12 19.5c.993 0 1.953-.138 2.863-.395M6.228 6.228A10.451 10.451 0 0 1 12 4.5c4.756 0 8.773 3.162 10.065 7.498a10.522 10.522 0 0 1-4.293 5.774M6.228 6.228 3 3m3.228 3.228 3.65 3.65m7.894 7.894L21 21m-3.228-3.228-3.65-3.65m0 0a3 3 0 1 0-4.243-4.243m4.242 4.242L9.88 9.88" />
                                    </svg>
                    ...
                    <div class="flex flex-col">
                        <button type="submit"
                            class="w-full bg-red-600 hover:bg-red-700 text-white py-4 rounded-md font-bold transition-all shadow-lg shadow-gray-200 active:scale-95 disabled:opacity-70 disabled:cursor-not-allowed disabled:active:scale-100 flex justify-center items-center">
                        ...
                        <div class="flex items-center justify-center space-x-2 mt-2 text-sm text-gray-500">
                            <span>Sudah terdaftar?</span>
                            <a class="font-bold text-red-600 hover:text-red-700 hover:underline decoration-2 underline-offset-4 transition-all"
                ...
                <p class="mt-10 text-center text-xs text-gray-400">
                    PT Sinar Sosro Gunung Slamat. Seluruh data Anda terjaga
                    kerahasiaannya.
                </p>
            </div>
        </div>
