    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        document.querySelectorAll("a[href]").forEach(link => {
            link.addEventListener("click", e => {
                ...
                // Loader saat ini tidak dirender (include-nya di-comment).
                // Biarkan browser melakukan navigasi normal jika loader tidak ada.
                if (!loader) return;
...
@if (!request()->routeIs('guest.login') && !request()->routeIs('guest.register'))
    <script>
