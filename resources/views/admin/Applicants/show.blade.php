...
@endphp
    ...
    <div class="max-w-5xl mx-auto py-8 px-4 sm:px-6 lg:px-8 bg-white shadow rounded-xl p-6">
        {{-- Action Buttons (Top) --}}
        <div class="mb-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4 no-print border-b border-gray-100 pb-6">
            
            {{-- Grup Kiri: Tombol Kembali & Judul --}}
            <div class="flex items-start gap-4">
                {{-- TOMBOL KEMBALI --}}
                <a href="{{ route('admin.applicants') }}" 
                class="mt-1 inline-flex items-center justify-center w-10 h-10 bg-white border border-gray-200 text-gray-600 rounded-lg hover:bg-gray-50 hover:text-red-600 transition-all shadow-sm group" 
                title="Kembali ke Kelola Pelamar">
                ...
                <div class="space-y-1">
                    <h2 class="text-xl font-bold text-gray-800 border-l-4 border-red-600 pl-3 h-12">
                        Resume <span class="text-red-600 italic">Preview</span>
                        <p class="text-sm text-gray-500">
                            Pelamar posisi: <span class="font-bold text-gray-700">{{ $job->judul_lowongan ?? '-' }}</span>
                        </p>
                    </h2>
                </div>
            </div>
            ...
            <div class="flex items-center gap-3">
                {{-- Tombol PDF --}}
                <a href="{{ route('admin.applicants.pdf', $application->id) }}"
                    target="_blank"
                    class="inline-flex items-center px-5 py-2.5 bg-red-600 text-white rounded-lg text-xs font-semibold uppercase tracking-wider hover:bg-red-700 active:bg-red-800 transition-colors shadow-sm">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                            ...
                            <div class="flex items-center gap-3 bg-white p-2 rounded-lg border border-gray-100 shadow-sm">
                                ...
                                <div class="truncate">
                                    ...
                                    <p class="text-xs font-semibold text-gray-600 truncate">{{ $user->email }}</p>
                                </div>
                            </div>
